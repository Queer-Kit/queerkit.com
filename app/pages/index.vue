...
useSeoMeta({
  title: "Queer Kit | Your Guide to All Things Queer",
  ogTitle: "Queer Kit | Your Guide to All Things Queer",
  description:
    "A collective resource for the LGBTQ+ community, covering history, identity, health, and more.",
  ogDescription:
    "A collective resource for the LGBTQ+ community, covering history, identity, health, and more.",
});
  ...
  <div class="bg-neutral-950 text-white selection:bg-primary-500 selection:text-white">
    ...
    >
      ...
      <div class="absolute inset-0 z-0">
        <div
          class="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-neutral-900 via-neutral-950 to-neutral-950 opacity-80"
        />
        <NuxtImg
          ...
          >
            ...
            <div class="absolute inset-0 p-8 flex flex-col justify-end">
              ...
              >
                ...
                <p
                  class="text-neutral-400 line-clamp-2 mb-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100"
                >
      ...
      <UContainer>
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="grid grid-cols-2 gap-8">
              <div>
                ...
                <div class="text-sm text-neutral-500 uppercase tracking-widest">
                  {{ t("home_vision_stat_articles") }}
                </div>
              </div>
              <div>
                <div class="text-4xl font-bold text-white mb-2">12+</div>
                <div class="text-sm text-neutral-500 uppercase tracking-widest">
                  {{ t("home_vision_stat_contributors") }}
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <UIcon
              name="lucide:info"
              class="w-16 h-16 text-white opacity-80 group-hover:scale-110 transition-transform duration-300"
            />
          </div>
        </div>
      </UContainer>
    ...
    <section class="py-32">
      <UContainer>
        ...
        <div
          class="grid grid-cols-1 md:grid-cols-3 gap-px bg-neutral-800 border border-neutral-800"
        >
          <div
            class="bg-neutral-950 p-8 hover:bg-neutral-900 transition-colors cursor-pointer group"
          >
            ...
            <p class="text-neutral-500 text-sm">{{ t("home_news_item_history_description") }}</p>
          </div>
          <div
            class="bg-neutral-950 p-8 hover:bg-neutral-900 transition-colors cursor-pointer group"
          >
            ...
            <p class="text-neutral-500 text-sm">{{ t("home_news_item_mod_description") }}</p>
          </div>
          <div
            class="bg-neutral-950 p-8 hover:bg-neutral-900 transition-colors cursor-pointer group"
          >
