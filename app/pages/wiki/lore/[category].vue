...
const columns: TableColumn<Page>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return h(
        "span",
        { class: "text-primary-100/60 line-clamp-1 max-w-md" },
        description || "---",
      );
    },
  },
    ...
    cell: ({ row }) => {
      return h(
        NuxtLink,
        {
          to: `/${row.original.slug}`,
          class:
            "inline-flex items-center gap-2 text-xs text-primary-500 font-bold uppercase hover:text-primary-400 transition-colors",
        },
        {
  ...
  <div class="space-y-12">
    ...
    <div v-else class="space-y-6">
      ...
      <UTable
        ...
        sticky
        class="border border-primary-800/50 bg-primary-800/10"
        :ui="{
      ...
      >
        <template #empty>
          <div class="p-12 text-center space-y-4">
            <UIcon name="lucide:inbox" class="size-16 text-primary-500/50 mx-auto" />
