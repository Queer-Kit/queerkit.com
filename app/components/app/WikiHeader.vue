...
<template>
  <RCHeader
    class="bg-primary-950/80 backdrop-blur-xl border-b border-primary-800/50 shadow-lg"
    :contain="false"
  >
    <template #left>
      <div class="flex flex-row items-center gap-md">
        <div class="flex items-center gap-2">
          <UIcon name="lucide:book-open" class="text-primary-400 size-5" />
    ...
    <template #collapsed-center>
      <div class="flex items-center gap-2">
        <UIcon name="lucide:book-open" class="text-primary-400 size-4" />
